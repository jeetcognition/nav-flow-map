...
import { routes, ALT_SUBORG_NAME, LOGIN_URL_PATTERN, DOCS_ORIGIN } from "../../support/paths";
...
test.describe("Enterprise Membership", () => {
  test("MEMB-SMK01 — Load the page cold.", async ({ page }) => {
    ...
    await expect(m.learnMoreLink).toHaveAttribute("href", `${DOCS_ORIGIN}/enterprise`);
